...
async def ForceSub(bot: Client, event: Message):
    ...
    try:
        ...
        await bot.send_message(
            ...
            text="<b>Hello {} 👋</b>\n\n<b>You cant use me untill subscribe our updates channel ☹️</b>\n<b>So Please join our updates channel by the following button and restart our bot by ( /logo) command 😊</b>".format(event.from_user.mention),
