...
from DewmiBot.pyrogramee.telethonbasics import is_admin
from DewmiBot.events import register
from DewmiBot.modules.mongo.nsfw_mongo import (
    nsfw_on,
    is_nsfw_on_enabled_chat,
    nsfw_off,
)
from DewmiBot import telethn, MONGO_DB_URI, BOT_ID
from DewmiBot.modules.sql.gshield_sql import (
    add_nsfwatch,
