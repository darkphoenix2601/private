...
import html
import requests
import DewmiBot.modules.sql.kuki_sql as sql

from time import sleep
from telegram import ParseMode
from DewmiBot import dispatcher, updater, SUPPORT_CHAT
...
def chatbot(update: Update, context: CallbackContext):
    ...
    if message.text and not message.document:
        ...
        kukiurl = requests.get('https://www.kukiapi.xyz/api/apikey=KUKIg76Fg4EIo/szrosebot/supun/message='+Message)
...
__help__ = """
Chatbot the Kuki's api which allows Kuki to talk and 
provide a more interactive group chat experience.
