...
async def restart_bot(dyno):
    ...
    if dyno.sender_id == OWNER_ID:
        ...
        return await dyno.reply("`Restarting your app, please wait for a minute!`"
         )
...
async def upgrade(dyno):
    ...
    if dyno.sender_id == OWNER_ID:
        ...
        return await dyno.reply(
            "`Your BOT is` **up-to-date** with [main](https://github.com/szsupunma/Rose-Bot)"
        )
    m = await dyno.reply("`Your BOT is` **up-to-date** with [main](https://github.com/szsupunma/Rose-Bot)")
