...
from DewmiBot.function.inlinehelper import *
from DewmiBot.function.pluginhelpers import fetch, json_prettify
from DewmiBot.services.pyrogram import pbot as app
...
__MODULE__ = "Inline"
__HELP__ = """
All Command Can found Here 
[Click Now](https://telegra.ph/Inline-Helper-11-28)
"""
...
async def inline_query_handler(client, query):
    try:
        ...
        if text.strip() == "":
            ...
            if len(reply) > 4095:
                reply = "lyrics too big, Try using /lyric"
