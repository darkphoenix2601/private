...
import DewmiBot.modules.filters.userinfo_sql as sql
...
from DewmiBot.modules.filters.user_sql import get_user_num_chats
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>stats of szrosebot📊:</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
    result = re.sub(r"(\d+)", r"<code>\1</code>", stats)
    PHOTO = "https://telegra.ph/file/af86f1ec606b572defdd2.jpg"
    update.effective_message.reply_photo(PHOTO, result, parse_mode=ParseMode.HTML)
