...
if ENV:
    ...
    JOIN_LOGGER = os.environ.get("JOIN_LOGGER", "-1001589738293")
    ...
    uchannel = os.environ.get("uchannel", "szteambots")
    BOT_USERNAME = os.environ.get("BOT_USERNAME", "szrosebot")
    ...
    MESSAGE_DUMP = os.environ.get("MESSAGE_DUMP", "-1001589738293")
...
rbot = Client("pakaya", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
